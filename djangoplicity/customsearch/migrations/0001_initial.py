    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(to='customsearch.CustomSearchField', on_delete=django.db.models.deletion.CASCADE)),
                ('layout', models.ForeignKey(to='customsearch.CustomSearchLayout', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(to='customsearch.CustomSearchField', on_delete=django.db.models.deletion.CASCADE)),
                ('search', models.ForeignKey(to='customsearch.CustomSearch', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='customsearchlayout',
            name='model',
            field=models.ForeignKey(to='customsearch.CustomSearchModel', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='customsearchcondition',
            name='search',
            field=models.ForeignKey(to='customsearch.CustomSearch', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='customsearch',
            name='group',
            field=models.ForeignKey(blank=True, to='customsearch.CustomSearchGroup', null=True, on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='customsearch',
            name='layout',
            field=models.ForeignKey(to='customsearch.CustomSearchLayout', on_delete=django.db.models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='customsearch',
