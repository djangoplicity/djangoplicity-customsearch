...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.create_table('customsearch_customsearchordering', (
			...
			('descending', self.gf('django.db.models.fields.BooleanField')(default=False)),
		))
		db.send_create_signal('customsearch', ['CustomSearchOrdering'])

		# Adding field 'CustomSearchLayoutField.expand_rel'
		db.add_column('customsearch_customsearchlayoutfield', 'expand_rel', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


	def backwards(self, orm):
		
		# Deleting model 'CustomSearchOrdering'
		db.delete_table('customsearch_customsearchordering')

		# Deleting field 'CustomSearchLayoutField.expand_rel'
		db.delete_column('customsearch_customsearchlayoutfield', 'expand_rel')
