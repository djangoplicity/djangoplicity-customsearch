...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomSearchField.enable_freetext'
        db.add_column('customsearch_customsearchfield', 'enable_freetext', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomSearchField.enable_freetext'
        db.delete_column('customsearch_customsearchfield', 'enable_freetext')
