...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomSearchField.sort_selector'
        db.add_column('customsearch_customsearchfield', 'sort_selector', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomSearchField.sort_selector'
        db.delete_column('customsearch_customsearchfield', 'sort_selector')
    ...
    models = {
        ...
        'customsearch.customsearch': {
            'Meta': {'ordering': "['name']", 'object_name': 'CustomSearch'},
        ...
        'customsearch.customsearchfield': {
            'Meta': {'ordering': "['model__name', 'name']", 'object_name': 'CustomSearchField'},
            'enable_freetext': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'sort_selector': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'})
        },
        ...
        'customsearch.customsearchlayoutfield': {
            'Meta': {'ordering': "['position', 'id']", 'object_name': 'CustomSearchLayoutField'},
